...
# ==========================
# uses scipy to perform "normal" SVD
# ===========================
...
class SvdMatrix:
    ...
    # trains the dataset by performing SVD
    # and retaining 80% of the "energy" as advised
    # in the dimensionaliy reduction section of our
    # textbook
    def train(self):
    ...
    #  calculates RMSE for the test dataset  
...
if __name__ == "__main__":
    # performs "normal" SVD on small dataset
    init = time.time()
